...
<head>
    ...
    <link href='../kz/testing/style.css' rel='stylesheet' type='text/css'>
    <script src='https://ajax.googleapis.com/ajax/libs/jquery/1.12.2/jquery.min.js'></script>
    <script src='https://ajax.googleapis.com/ajax/libs/angularjs/1.2.16/angular.min.js'></script>
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.2.16/angular-route.js"></script>
    <script src='../kz/testing/testing.js'></script>
    ...
    <div>
        ...
        <div class="container filter-gradient blue">
            <div class="content">
                ...
                <p class="tagline">
                    «Cіздің психологиялық портретіңіз»
                </p>
                <div ng-hide="testStarted">
                    <p>
                        <center style="padding: 0 50px;">
                            Әрбір 28 жұптағы бекімнен кейін, Сізге лайықты біреуін ғана (А немесе Б) таңдаңыз. Есіңізде болсын, оның ішінде нашар немесе тәуірі, дұрысы немесе бұрысы жоқ, барлығы да бірдей.
                        </center>
                    </p>
                    <p>
                        <b>
                            <center>
                                Жауабына көп ойланбай, тез қимылдаңыз.
                            </center>
                        </b>
                    </p>
                    <div class="row">
                ...
                <form ng-show="testStarted && !testEnded">
                    ...
                    <div class="row">
                        <button class="backButton" ng-click="back()"><i class="fa fa-arrow-left icon"></i>Артка карай</button>
                        <button class="nextButton" ng-click="counter=counter+1" ng-disabled="questions[counter].answer==undefined" ng-hide="counter+1==questionsCount">Ари карай<i class="fa fa-arrow-right icon"></i></button>
                        <button class="finishButton" ng-click="finish()" ng-disabled="questions[counter].answer==undefined" ng-show="counter+1==questionsCount">Аяқтау<i class="fa fa-check-circle icon"></i></button>
                    </div>
                </form>
                <div ng-if="testEnded">
                    <p>
        ...
        <footer class="footer">
            <div id="vk_temp" style="display:-webkit-inline-box;">
                <a ng-show="testEnded" target="_blank" title="Өз ойыңызбен бөлісіңіз" href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.urway.kz%2Ftest.php%3Fsymbol%3D{{tableSymbol}}"><img style="height:21px; margin-right:10px;" src="/img/facebook_ru.png"></a>
                <a ng-show="!testEnded" target="_blank" title="Өз ойыңызбен бөлісіңіз" href="http://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.urway.kz%2F"><img style="height:21px; margin-right:10px;" src="/img/facebook_ru.png"></a>
                <div ng-show="!testEnded">
                <script type="text/javascript">
                    document.write(VK.Share.button({
                        url: 'http://www.urway.kz/',
                    }, {type: 'round', text: 'Өз ойыңызбен бөлісіңіз'}));
                </script>
                </div>
            </div>
            <script type="text/javascript">
